                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="info-tab">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Código de habitación</label>
                                    <div class="col-lg-5">
                                     ...
                                     <div class="form-group">
                                    <label class="col-lg-3 control-label">Número de habitación</label>
                                    <div class="col-lg-5">
                            ...
                            <div class="col-lg-5">
                              ...
                              <div class="form-group">
                            <label class="col-lg-3 control-label">Tipo Habitación</label>
                            <div class="col-lg-5">
                                <select class="form-control" name="cbotipo">
                                    <option value="">-- Seleccione tipo de habitacioón --</option>
                                    <option value="fr">Desayuno</option>
                                    <option value="de">Almuerzo</option>
                                    <option value="it">Comidas</option>
                            ...
                            <div class="col-lg-5">
                                <select class="form-control" name="cboEstado">
                                    ...
                                    <option value="fr">Disponible</option>
                                    <option value="de">Reservada</option>
                                    <option value="it">Ocupada</option>
                                    <option value="it">Mantenimiento</option>
